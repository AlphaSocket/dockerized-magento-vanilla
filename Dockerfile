...
ADD imports/bin/setup /usr/local/bin/setup/1518359769
ADD imports/bin/config /usr/local/bin/config/1518359769
ADD imports/bin/docker-config /usr/local/bin/docker-config
ADD imports/bin/docker-run /usr/local/bin/docker-run
ADD imports/bin/setup /usr/local/bin/setup/1518359769
ADD imports/bin/config /usr/local/bin/config/1518359769
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518359769 1>/dev/stdout 2>/dev/stderr
