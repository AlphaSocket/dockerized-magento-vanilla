...
ADD imports/bin/setup /usr/local/bin/setup/1518367346
ADD imports/bin/config /usr/local/bin/config/1518367346
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518367346 1>/dev/stdout 2>/dev/stderr
