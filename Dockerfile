...
ADD imports/bin/setup /usr/local/bin/setup/1518814458
ADD imports/bin/config /usr/local/bin/config/1518814458
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518814458 1>/dev/stdout 2>/dev/stderr
