...
ADD imports/bin/setup /usr/local/bin/setup/1518735092
ADD imports/bin/config /usr/local/bin/config/1518735092
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518735092 1>/dev/stdout 2>/dev/stderr
