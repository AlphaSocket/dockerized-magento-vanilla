...
ADD imports/bin/setup /usr/local/bin/setup/1518735499
ADD imports/bin/config /usr/local/bin/config/1518735499
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518735499 1>/dev/stdout 2>/dev/stderr
