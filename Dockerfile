...
ENV \
	...
	SETUP_CACHE_MAGENTO_SAMPLE_DATA_CHECKSUM_1.9.2.4_MD5="ddb2103137e257006e30b66122caa999" \
...
ADD imports/bin/setup /usr/local/bin/setup/1518365740
ADD imports/bin/config /usr/local/bin/config/1518365740
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1518365740 1>/dev/stdout 2>/dev/stderr
